...
interface AddCarFormProps {
  onSubmit: (data: CarCreate) => void | Promise<void>
}
...
export default function AddCarForm({ onSubmit }: AddCarFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Convert form data to CarCreate type
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-lg border border-border bg-card p-6 sm:p-8 shadow-sm">
      <div className="space-y-6">
        ...
        <div>
          ...
          />
          {errors.make && <p className="mt-2 text-sm text-destructive">{errors.make}</p>}
        </div>
        ...
        <div>
          ...
          <Input
            ...
            disabled={isSubmitting}
          />
          {errors.model && <p className="mt-2 text-sm text-destructive">{errors.model}</p>}
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            ...
            <Input
              ...
              disabled={isSubmitting}
            />
            {errors.year && <p className="mt-2 text-sm text-destructive">{errors.year}</p>}
          </div>
          ...
          <div>
            ...
            {errors.price && <p className="mt-2 text-sm text-destructive">{errors.price}</p>}
          </div>
        </div>
        ...
        <div>
          ...
          <Input
            ...
            min="0"
          />
          {errors.mileage && <p className="mt-2 text-sm text-destructive">{errors.mileage}</p>}
        </div>
